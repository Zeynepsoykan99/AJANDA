...
function HueSlider({ gestures = [], style = {}, vertical = false, reverse = false, ...props }) {
  ...
  const thumbAnimatedStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([width, height, hueValue, handleScale, vertical, reverse, boundedThumb, thumbSize]),
  );
  const activeSaturationStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([brightnessValue, saturationValue, adaptSpectrum]),
  );
  const activeBrightnessStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([brightnessValue, adaptSpectrum]),
  );
  const imageStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([width, height, vertical, reverse]),
  );
  const onBegin = () => {
    'worklet';
