...
function SaturationSlider({ gestures = [], style = {}, vertical = false, reverse = false, ...props }) {
  ...
  const thumbAnimatedStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([width, height, saturationValue, handleScale, vertical, reverse, boundedThumb, thumbSize]),
  );
  const activeColorStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([hueValue]),
  );
  const activeBrightnessStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([adaptSpectrum, brightnessValue]),
  );
