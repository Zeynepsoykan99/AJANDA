...
function GreenSlider({ gestures = [], style = {}, vertical = false, reverse = false, ...props }) {
  ...
  const greenValue = (0, _reactNativeReanimated.useSharedValue)(0);
  const rgb = (0, _reactNativeReanimated.useDerivedValue)(
    ...
    (0, _utils.getWebDependencies)([hueValue, saturationValue, brightnessValue, greenValue]),
  );
  ...
  const sliderBackground = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([rgb, adaptSpectrum]),
  );
  const onBegin = () => {
    'worklet';
