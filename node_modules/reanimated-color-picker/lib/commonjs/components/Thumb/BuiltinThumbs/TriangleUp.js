...
function TriangleUp({ width, height, thumbColor, adaptiveColor, thumbAnimatedStyle, innerStyle, style, vertical }) {
  const computedStyle = {
    width,
    height,
    ...(vertical
  ...
  const adaptiveColorStyle = (0, _reactNativeReanimated.useAnimatedStyle)(
    ...
    (0, _utils.getWebDependencies)([thumbColor, adaptiveColor]),
  );
  return /*#__PURE__*/ _react.default.createElement(
    _reactNativeReanimated.default.View,
    {
      style: [_styles.styles.handle, style, computedStyle, thumbAnimatedStyle],
