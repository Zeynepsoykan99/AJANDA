import type { ColorFormats, ColorParseResult, ColorTypes, ConversionMethods, HslaT, HsvaT, HwbaT, RgbaT, SupportedColorFormats } from './types';
export declare const colorKitUI: () => {
    HEX: (color: SupportedColorFormats, forceAlpha?: boolean) => string;
    ...
    parse: (color: SupportedColorFormats) => ColorParseResult | undefined;
