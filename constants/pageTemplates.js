...
export const PAGE_TEMPLATES = {
  ...
  weekly: [
    ...
    },
    {
      ...
      colors: { bg: '#FFF0F5', accent: '#C2185B', header: '#880E4F', day: '#FFFFFF', border: '#F8BBD0', grid: '#F8BBD055' },
      pattern: 'hearts',
      paperType: 'pink_grid',
      decorations: 'daisy_ribbon',
    },
    {
      id: 'weekly_lavender_ribbon',
      name: 'Lavanta & Kurdele',
      colors: { bg: '#F3E5F5', accent: '#7B1FA2', header: '#4A148C', day: '#FFFFFF', border: '#CE93D8', grid: '#CE93D850' },
      pattern: 'stars',
      paperType: 'lavender_grid',
      decorations: 'lavender_bow',
    },
    {
      id: 'weekly_buttercup_sun',
      name: 'Güneş Papatyası',
      colors: { bg: '#FFFDE7', accent: '#F57F17', header: '#E65100', day: '#FFFFFF', border: '#FFF59D', grid: '#FFF59D65' },
      pattern: 'dots',
      paperType: 'yellow_grid',
      decorations: 'buttercup_daisy',
    },
    {
      id: 'weekly_cloud_daydream',
      name: 'Bebek Mavisi Bulutlar',
      colors: { bg: '#E1F5FE', accent: '#0288D1', header: '#01579B', day: '#FFFFFF', border: '#B3E5FC', grid: '#B3E5FC55' },
      pattern: 'stars',
      paperType: 'blue_grid',
      decorations: 'cloud_ribbon',
    },
    {
      id: 'weekly_pink',
      name: 'Klasik Pembe Haftalık',
